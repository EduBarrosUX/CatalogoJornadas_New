import imgBotBb1 from "@/assets/462cecd9598a19310a8b922bc28042a66f30d2af.png";
import img01 from "@/assets/108d199cecf3b3b5b2b743995a6dc91b1b7a18b9.png";

export default function Group() {
  return (
    <div className="relative size-full">
      <div className="absolute h-[337px] left-[638px] rounded-[44px] top-[207px] w-[323px]" data-name="BOT_BB_1">
