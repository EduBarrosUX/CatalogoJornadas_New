...
interface Passo5FormularioProps {
...
export function Passo5Formulario({ register, errors, canaisSelecionados, onCanaisChange }: Passo5FormularioProps) {
  ...
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-start w-full max-w-[672px]">
      <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full">
        ...
        {/* Campo 17: Radio Buttons de Canais */}
        <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
          <p className="css-4hzbpn font-['BancoDoBrasil_Textos:Medium',sans-serif] leading-[1.125] not-italic relative shrink-0 text-[#111214] text-[14px] tracking-[0.07px] w-full">
            17. Em qual canal esse fluxo será disponibilizado?
          </p>
          <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
            {canais.map((canal) => (
