...
export function ModalConsultaFeedbacks({ onClose, registros }: ModalConsultaFeedbacksProps) {
  ...
  return (
    ...
    >
      <div
        className={`bg-white rounded-[20px] w-[900px] max-w-[95vw] max-h-[85vh] overflow-hidden shadow-[0px_10px_25px_0px_rgba(0,0,0,0.25)] transition-all duration-200 ${
