...
export default function App() {
  ...
  const [jornadas, setJornadas] = useState<JornadaCadastrada[]>([
    ...
    },
    {
      tipoHU: 'Ativo',
      tema: 'Investimentos',
      numeroHistoria: '10203044',
      tituloFluxo: 'Aplicação Automática CDB',
      descricaoFluxo: 'Fluxo para ativar aplicação automática de saldo em CDB.',
      segmento: ['Varejo'],
      canais: ['App BB'],
      personas: ['Cliente PF'],
      iniciativas: 'Produtos de Investimento',
      rme: 'RME-0002',
      linkFigma: 'https://www.figma.com/file/exemplo-cdb',
      dataAbertura: '02/02/2026',
      status: 'Implementada',
      publico: 'PF',
      tipoInclusao: 'Nova Jornada',
      diretoria: 'DIR-04',
      sistemaResponsavel: 'Sistema de Investimentos',
      cadastradoPor: 'Fernanda Alves',
      chaveUsuario: 'F5678901',
      utilizaIAGenerativa: false,
      iaGenerativaRespondeCliente: false,
      inputGatilho: 'Cliente ativa aplicação automática no app',
      nomeHashInicial: '#cdb-auto',
      hashInicio: '#cdb'
    },
    {
      tipoHU: 'Transação',
      tema: 'Cartões',
      numeroHistoria: '10203045',
      tituloFluxo: 'Contestação de Compra',
      descricaoFluxo: 'Fluxo de contestação de compra no cartão de crédito.',
      segmento: ['Varejo'],
      canais: ['WhatsApp'],
      personas: ['Cliente PF'],
      iniciativas: 'Atendimento Digital',
      rme: 'TRN-0002',
      linkFigma: 'https://www.figma.com/file/exemplo-contestacao',
      dataAbertura: '05/02/2026',
      status: 'Excluída',
      publico: 'PJ',
      tipoInclusao: 'Alteração',
      diretoria: 'DIR-02',
      sistemaResponsavel: 'Sistema de Cartões',
      cadastradoPor: 'Rafael Mota',
      chaveUsuario: 'F6789012',
      utilizaIAGenerativa: false,
      iaGenerativaRespondeCliente: false,
